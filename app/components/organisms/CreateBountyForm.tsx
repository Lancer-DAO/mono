...
const CreateBountyForm: React.FC<{
  ...
  return (
    <Form title={"New Lancer Quest"}>
      <>
        <div>
          <label>
            Issue Title<span className="text-[#ff6969]">*</span>
          </label>
          <input
            type="text"
        ...
        <div>
          <label className="field-label-2">
            Est. Time to Completion<span className="text-[#ff6969]">*</span>
          </label>
          <input
            type="number"
            className="input w-input"
        ...
        <div>
          <label className="field-label">
            Coding Languages<span className="text-[#ff6969]">* </span>
          </label>
          <input
            type="text"
            className="input w-input"
        ...
        >
          <div className="description-label">
            <label>
              Description<span className="text-[#ff6969]">*</span>
            </label>
            <button
        ...
        <label>
          Funding Type<span className="text-[#ff6969]">*</span>
        </label>
        {mints && (
          <div
            data-delay="0"
                ...
                <>
                  ...
                  <div>
                    {mint ? (
                      ...
                      <div>
                        Select Mint <span className="text-[#ff6969]">* </span>
                      </div>
                    )}
                  </div>
                </>
        ...
        <div className="required-helper">
          <span className="text-[#ff6969]">* </span> Required
        </div>
        <Button
